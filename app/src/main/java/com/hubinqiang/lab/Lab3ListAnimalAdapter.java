...
public class Lab3ListAnimalAdapter extends ArrayAdapter<Lab3ListAnimal>{

    private int resourceID;


    public Lab3ListAnimalAdapter(Context context, int textViewResourceId, List<Lab3ListAnimal> objects) {
